...
\title{\textbf{...remove min/max speed from FP...}\\Evoflock: evolved inverse design of multi-agent motion}
...
The work described here is part of a larger project. Many thanks for conversations and camaraderie to my collaborators: Gilbert Bernstein, Matthew Shang, and Jennifer Luo. I also want to thank my long time (~30 year) friend and ALife colleague, Inman Harvey, whose deep insights taught me much about evolutionary computation and scholarship. Thanks to my family for loving support. [[[\textbf{revisit this}]]]
% Wahrman(?)
% flocking friends?
