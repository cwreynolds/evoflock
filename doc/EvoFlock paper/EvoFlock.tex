...
Since the 1980s many simulation-based models of bird flocks have been proposed. Although they have broadly similar intent, there are many differences in their modeling philosophy and computational technique. These models include \textit{boids} and others:
...
% GP uses an arbitrary tree-shaped genomes while GA uses a fixed size vector of parameters.
...
[[[\textbf{note ``...In this paper, we propose such a flocking model for real drones incorporating an evolutionary optimization framework with carefully chosen order parameters and fitness functions...'' \citep{vasarhelyi_optimized_2018}
}]]]
