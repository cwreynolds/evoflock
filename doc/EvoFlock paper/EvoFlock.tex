...
[[[...list the parameters, talk a bit about the flocking model...]]]

[[[...note that flocking model needs to be cleaned up and that I'm using ``evolved speed control''...]]]

\section{An objective function for flocking}
\label{sec:flocking_objective}
...
[[[...make experiment with goal of increasing path curvature. If it works describe here. Otherwise put it in \nameref{sec:future}...]]]
...
[[[...go through all papers in my Zotero with the tag \textit{evoflock}...]]]
