...
// First define some global constants for EvoFlock
namespace EvoFlock
{
...
// Next, include Utilities.h for the RandomSequence class
#include "Utilities.h"


// Then define various accessors EF::RS(), the shared random number generator.
// This API is used throughout the EvoFlock codebase.
namespace EvoFlock
{
// Acessors for global RS (RandomSequence) for all of EvoFlock
...
// Include other EvoFlock headers
#include "Agent.h"
#include "Boid.h"
#include "dbscan.h"
#include "Draw.h"
