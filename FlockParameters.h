...
//
//  TODO 20250324 changing this policy, from:
//      Note that all distances are expressed in units of body_diameter which
//      "just happen" to be 1
//  to:
//      Distances and body_diameter are meant to be in meters. But a spherical
//      boid 1 meter in diameter is quite large (in the eagle/condor/vulture
//      range). Because all these parameters interact, it will probably not be
//      meaningful to share or compare parameters between flocks. Boids that are
//      bigger/smaller, faster/slower, or whatever, will need to be optimized
