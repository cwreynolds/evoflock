...
//        use_cluster_objective   = false;
        ...
        //~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
        // TODO 20260805 try murm without cluster and centroid objective
//        use_cluster_objective   = true;
        use_cluster_objective   = false;
        //~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
void visualizePreviouslyLoggedFlockParameters(const LP::FunctionSet& fs)
{
    ...
    if (EF::usingGA())
    {
        ...
        // Saved best FP values from run 20260802_ga_murm_manifold_2
        // FlockParameters fp({24.8298, 94.68, 80.9825, 81.347, 84.2592,
        //                     68.4585, 73.9261, 3.27182, 6.04222,
        ...
        // Saved best FP values from run 20260825_ga_murm_manifold_score
        // FlockParameters fp({94.1794, 99.241, 48.5187, 43.0059, 16.8818,
        //                     96.6694, 51.972, 2.14696, 54.605, 1.40219,
        //                     -0.867327, -0.631353, 0.834589, 24.8523,
        //                     3.70292, 48.7441, 1.71112, 54.8331, 0.281462,
        //                     0.05996, 0.183782});
                
        // Saved best FP values from run 20260825_ga_murm_manifold_score_3
        // FlockParameters fp({86.4532, 96.3334, 72.4392, 59.7222, 22.9937,
        //                     16.3045, 10.3285, 1.97198, 57.5973, 1.41003,
        //                     -0.344897, -0.0402314, 0.797583, 39.8294,
        //                     2.20833, 19.6932, 1.48472, 49.3354, 0.0561993,
        //                     0.393809, 0.605197});
        
        // Saved best FP values from run 20260906_ga_murm_10x_sim_pop
        // FlockParameters fp({93.0774, 82.3096, 43.138, 48.3765, 13.3446,
        //                     72.8708, 51.8012, 2.92731, 99.5295, 7.60025,
        //                     -0.964567, -0.0159354, 0.980691, 25.9475,
        //                     7.53847, 15.2021, 1.9944, 5.55988, 0.0370345,
        //                     0.04439, 0.307304});
        
        // Saved best FP values from run 20260906_ga_murm_5x_sim_pop
        // FlockParameters fp({91.1486, 97.0807, 55.9731, 87.1233, 2.97699,
        //                     41.8159, 35.3071, 2.62889, 95.4553, 95.0864,
        //                     -0.820193, -0.748972, 0.594211, 38.9565,
        //                     3.90494, 44.8738, 1.37631, 76.4729, 0.0452195,
        //                     0.855091, 0.0898227});
        
        // Saved best FP values from run 20260906_ga_murm_fix_approx_plane
        // FlockParameters fp({65.526, 91.9577, 51.7729, 79.0655, 0.739911,
        //                     8.21947, 51.1366, 3.06915, 31.5526, 73.534,
        //                     -0.795571, -0.969805, 0.07487, 91.1783,
        //                     0.205837, 23.7056, 1.97422, 18.8747,
        //                     0.0186537, 0.780028, 0.787636});
        
        // Saved best FP values from run 20260911_ga_murm_new_manifold_score
        // FlockParameters fp({74.3531, 98.4527, 46.922, 72.226, 4.06004,
        //                     18.3368, 73.0241, 2.60081, 44.676, 66.1557,
        //                     -0.810327, -0.940605, -0.566079, 15.5466,
        //                     4.69712, 36.8232, 1.51684, 82.2004, 0.0320561,
        //                     0.0698028, 0.451804});
        
        // Saved best FP values from run 20260911_ga_murm_uniform_cent_score
        // FlockParameters fp({64.1909, 98.3177, 68.416, 90.7684, 1.64565,
        //                     27.5045, 92.7362, 2.12664, 18.8126, 88.5102,
        //                     -0.885245, -0.963309, -0.106566, 90.1209,
        //                     1.49962, 37.134, 1.69438, 68.8411, 0.101773,
        //                     0.688531, 0.0381261});
        
        // Saved best FP values from run 20260913_ga_murm_to_cent_when_outbound
        // FlockParameters fp({86.9217, 86.6591, 56.3106, 68.2509, 2.83079,
        //                     35.6366, 86.8859, 2.24228, 60.3239, 75.5524,
        //                     -0.856361, -0.671799, -0.0437539, 68.9765,
        //                     3.22642, 27.7987, 1.31201, 41.0895, 0.0457202,
        //                     0.813601, 0.933783});
        
        // Saved best FP values from run 20260914_ga_murm_tweak_TowardCentroid_v3
        // FlockParameters fp({63.576, 93.3162, 55.6051, 52.8443, 5.67446,
        //                     75.0135, 10.9963, 2.25209, 68.6616, 90.1373,
        //                     -0.903679, 0.136535, 0.535923, 17.6932,
        //                     2.30834, 21.0137, 1.42478, 79.5345, 0.0294618,
        //                     0.22269, 0.329968});
        
        // Saved best FP values from run 20260917_ga_murm_tune_anti_donut_hole
        // FlockParameters fp({96.7795, 94.6618, 81.6187, 65.9294, 0.162333,
        //                     38.2249, 21.4856, 1.93228, 29.1105, 67.9278,
        //                     -0.799061, -0.816402, -0.93844, 43.1481,
        //                     5.97883, 3.77211, 1.66532, 46.2998, 0.156128,
        //                     0.518358, 0.601389});
        
        // Saved best FP values from run 20260917_ga_murm_enough_jiggle_03_to_02
        // FlockParameters fp({64.8474, 92.3363, 44.437, 76.7676, 0.337323,
        //                     10.549, 60.9972, 2.26667, 48.0627, 27.7182,
        //                     -0.918118, -0.918184, -0.261904, 6.00552,
        //                     2.16409, 15.7198, 1.87228, 58.0778, 0.05792,
        //                     0.985117, 0.560822});

        // Saved best FP values from run 20260918_ga_murm_farness_05_to_03
        // FlockParameters fp({79.0482, 88.9208, 51.0767, 78.3203, 2.52964,
        //                     31.1507, 87.7312, 2.07426, 24.8421, 14.057,
        //                     -0.493774, -0.903136, -0.415672, 1.33317,
        //                     2.43229, 36.3388, 1.6581, 41.1128, 0.0277898,
        //                     0.102002, 0.729913});

        // Saved best FP values from run 20260919_ga_murm_allow_less_manifold_dist
        // FlockParameters fp({95.294, 90.065, 46.689, 53.6358, 0.636699,
        //                     12.4929, 5.9585, 2.10064, 9.96472, 14.9706,
        //                     -0.864903, -0.610923, 0.367173, 38.0237,
        //                     0.364554, 16.2971, 1.10454, 41.5959, 0.130546,
        //                     0.740235, 0.776882});

        // Saved best FP values from run 20260920_ga_murm_revert_heading_away
        // FlockParameters fp({67.6838, 73.7707, 54.2905, 61.3709, 0.177133,
        //                     76.1276, 79.324, 2.05492, 30.2309, 93.0639,
        //                     -0.910008, -0.944198, 0.485371, 77.9386,
        //                     8.89312, 20.3317, 1.153, 65.73, 0.144615,
        //                     0.675688, 0.158847});

        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // TODO 20260922_ga_murm_add_back_heading_away with bigger flock
        
        // Saved best FP values from run 20260922_ga_murm_add_back_heading_away
        FlockParameters fp({97.5374, 96.9989, 56.0619, 55.8874, 0.0876186,
                            39.2949, 81.8571, 2.05814, 13.3781, 11.1687,
